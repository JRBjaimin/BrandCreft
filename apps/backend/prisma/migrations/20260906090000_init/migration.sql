...
CREATE TABLE "categories" (
    ...
    "key" TEXT NOT NULL,
    "label" TEXT NOT NULL,
    "rateModuleEnabled" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "business_users" (
    ...
    CONSTRAINT "business_users_pkey" PRIMARY KEY ("businessId","userId")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "feature_flags_key_categoryId_businessId_key" ON "feature_flags"("key", "categoryId", "businessId");
...
-- AddForeignKey
ALTER TABLE "feature_flags" ADD CONSTRAINT "feature_flags_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "categories"("id") ON DELETE CASCADE ON UPDATE CASCADE;
